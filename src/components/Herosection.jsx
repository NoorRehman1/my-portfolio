...
const HeroSection = () => {
  return (
    <section className="min-h-screen bg-gradient-to-r from-[#e0e7ff] to-[#f8fafc] flex items-center px-6 py-16">
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            Hi, I'm{" "}
            <span className="text-6xl font-bold bg-gradient-to-r from-orange-300 to-cyan-400 bg-clip-text text-transparent">
              NOOR REHMAN
            </span>
          </motion.h1>
        ...
        >
          <img
            src="/myphoto.png"
            alt="My Photo"
            className="w-[300px] md:w-[400px] rounded-full shadow-2xl object-cover border-4 border-black"
          />
        </motion.div>
      </div>
    </section>
